    ...
    >
      <FontAwesomeIcon icon={item.icon} />
        ...
        <nav className="mt-8 space-y-4">
          ...
          <a href="#portfolio" className="block hover:bg-gray-700 p-2 rounded">Portfólio</a>
          <a href="#habilidades" className="block hover:bg-gray-700 p-2 rounded">Habilidades</a>
          <a href="#contatos" className="block hover:bg-gray-700 p-2 rounded">Contatos</a>
        </nav>
      </aside>
    </>
  );
